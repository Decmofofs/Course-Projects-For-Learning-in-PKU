    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->MidPointStarter->setGeometry(QRect(760,260,ui->MidPointStarter->width(),ui->MidPointStarter->height()));
    ui->ErosionStarter->setGeometry(QRect(760,340,ui->ErosionStarter->width(),ui->ErosionStarter->height()));
    ui->wwdx->setGeometry(QRect(760,420,ui->wwdx->width(),ui->wwdx->height()));
...
void MainWindow::on_MidPointStarter_clicked()
{
    widget = new MidPointWidget();
    widget->setWindowTitle(QString("MidPoint 展示"));
    widget->show();
...
void MainWindow::on_ErosionStarter_clicked()
{
    widget = new HydraulicErosionWidget();
    widget->setWindowTitle(QString("Hydraulic Erosion 展示"));
    widget->show();
